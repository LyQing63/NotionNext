...
const BLOG = {
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '245466821985584', // Facebook Page ID 來啟用 messenger 聊天功能
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '953183326158027', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
